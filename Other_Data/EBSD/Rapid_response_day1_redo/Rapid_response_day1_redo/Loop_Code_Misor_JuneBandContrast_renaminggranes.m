...
CS = {... 
  ...
  crystalSymmetry('mmm', [18 8.8 5.2], 'mineral', 'Enstatite  Opx AV77', 'color', [0.85 0.65 0.13]),...
  crystalSymmetry('12/m1', [9.7 9 5.3], [90,105.63,90]*degree, 'X||a*', 'Y||b*', 'Z||c', 'mineral', 'Diopside   CaMgSi2O6', 'color', [0.94 0.5 0.5])};
% plotting convention
...
if strcmp(day_set, 'day1');
    pname ="D:\Charlotte Devitre\EBSD\Kam_R3\Kam_R3\h5oina";
elseif strcmp(day_set, 'day1_ctf');
       pname="D:\Charlotte Devitre\EBSD\Kam_Kam2\Kam_Kam2\ctf";
...
files = dir(fullfile(pname, '*.h5oina')); % was '*.ctf'#
...
plot(grains.boundary, 'lineColor', 'r', 'DisplayName', 'Grain boundary');
