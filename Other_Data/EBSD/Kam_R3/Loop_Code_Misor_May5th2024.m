...
if strcmp(day_set, 'day1');
       pname="P:\WORK-GENERAL\POSTDOC-UCB\BERKELEY-VIBE\Documents\Projects\Kamaehu2024\2large4GIT\EBSD\Kam_R3\Kam_R3\h5oina"
else
...
files = dir(fullfile(pname, '\*.h5oina')); % was '*.ctf'#'\*.h5oina'
