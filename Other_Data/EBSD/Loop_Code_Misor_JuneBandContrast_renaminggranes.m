...
elseif strcmp(day_set, 'day1');
    pname='C:\Users\penny\Box\Berkeley_new\Raman\MaunaLoa\EBSD\Data_ML_EBSD\Day1';
...
files = dir(fullfile(pname, '\ori2_ol1 - EBSD Data.ctf')); % was '*.ctf'#
